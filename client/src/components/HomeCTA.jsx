...
const HomeCTA = () => {
  return (
    ...
    <section className="py-10 md:py-16 bg-warm-ivory text-charcoal-black relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10 items-center">
          ...
          <motion.div
            ...
            className="text-left"
          >
            <span className="text-gold-accent font-inter text-xs md:text-sm uppercase tracking-widest mb-2 md:mb-3 block font-semibold">
              Start Your Journey
            </span>
            <h2 className="font-playfair text-3xl sm:text-4xl md:text-5xl mb-3 md:mb-4 leading-tight text-charcoal-black">
              Ready to frame your{" "}
              <span className="italic text-gold-accent">moments?</span>
            </h2>
            <p className="font-inter text-charcoal-black/70 text-sm md:text-base mb-6 font-light max-w-xl leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-4 md:gap-6 text-xs md:text-sm font-inter text-charcoal-black/60">
              <div>
                <h3 className="text-charcoal-black uppercase tracking-widest mb-1 font-bold text-xs">
                  Email
                </h3>
